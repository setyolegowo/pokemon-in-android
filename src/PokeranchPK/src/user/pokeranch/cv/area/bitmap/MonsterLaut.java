...
public class MonsterLaut {
	...
	public static void init() {
		monster = DrawableManager.getInstance().getMonsterShadow();
	...
	public MonsterLaut(int IX, int IY, int type){
		this.PosIX=IX;
		this.PosIY=IY;
